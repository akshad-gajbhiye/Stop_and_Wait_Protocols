...
class rdt_Sender(object):
	...
	def rdt_rcv(self,packt):
		...
		if(packt.payload=="ACK0" and self.state==WAIT_FOR_ACK_0):
			...
			# 	sys.exit(0)
			return True
		elif(packt.payload=="ACK1" and self.state==WAIT_FOR_ACK_0):
			return False
		elif(packt.payload=="ACK1" and self.state==WAIT_FOR_ACK_1):
			...
			# 	sys.exit(0)
			return True
		elif(packt.payload=="ACK0" and self.state==WAIT_FOR_ACK_1):
			return False
